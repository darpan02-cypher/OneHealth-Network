...
def add_medical_history(request):
    # Logic to add medical history
    return render(request, 'patientmedicalhistory/add.html')

def edit_medical_history(request, id):
    # Logic to edit medical history
    return render(request, 'patientmedicalhistory/edit.html')

def delete_medical_history(request, id):
    # Logic to delete medical history
    return render(request, 'patientmedicalhistory/delete.html')
...
def saveMedHistoryInfo(request):
    if request.method == 'POST':
        # Logic to save medical history information
        # Example: Save data to the database
        # medical_history = MedicalHistory(
        #     user_name=request.session.get('member_id'),
        #     history_details=request.POST.get('historyDetails')
        # )
        # medical_history.save()
        return redirect('patientmedicalhistory:index')  # Redirect after saving
    return render(request, 'patientmedicalhistory/index.html')  # Render the form if not POST